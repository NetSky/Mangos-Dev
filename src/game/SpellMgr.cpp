    ...
    switch(spellInfo_1->SpellFamilyName)
    {
        ...
        case SPELLFAMILY_MAGE:
            if ( spellInfo_2->SpellFamilyName == SPELLFAMILY_MAGE )
            {
                ...
                // Focus Magic Buff - Proc
                if ( (spellInfo1->Id == 54648) && (spellInfo2->Id == 54646) ||
                    (spellInfo2->Id == 54648) && (spellInfo1->Id == 54646) )
                    return false;
                
                // Imp Scorch & Winter's Chill
                if ( (spellInfo1->Id == 22959) && (spellInfo2->Id == 12579) ||
                    (spellInfo2->Id == 22959) && (spellInfo1->Id == 12579) )
                    return false;                                 
            }
...
DiminishingGroup GetDiminishingReturnsGroupForSpell(SpellEntry const* spellproto, bool triggered)
{
    ...
    switch(spellproto->SpellFamilyName)
    {
        ...
        case SPELLFAMILY_HUNTER:
        {
            ...
            else if  (spellproto->SpellIconID == 180 || spellproto->SpellIconID == 1721)
                return DIMINISHING_DISORIENT;
            break;
        }
        case SPELLFAMILY_WARLOCK:
        ...
        case SPELLFAMILY_PRIEST:
        {
            ...
            if ((spellproto->SpellFamilyFlags & UI64LIT(0x00000000004)) && spellproto->SpellIconID == 150)
                return DIMINISHING_LIMITONLY;
            // Mind Control
            else if ((spellproto->SpellFamilyFlags & UI64LIT(0x00000020000)) && spellproto->SpellIconID == 150)
